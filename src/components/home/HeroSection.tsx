  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
      ...
      <div className="lg:col-span-6 flex flex-col items-start gap-5">
        ...
        <p className="text-text-muted text-sm sm:text-base leading-relaxed max-w-lg">
        ...
        {/* Social Icons */}
        <div className="flex items-center gap-4 pt-4 border-t border-card-border/40 w-full">
      ...
      {/* Right Column: Decorative Terminal Window */}
