...
interface ViceLeadershipProps {
  members?: BoardMember[];
}

export default function ViceLeadership({ members: initialMembers }: ViceLeadershipProps) {
  ...
  const viceMembers = members.filter((m) => m.category === "Vice Leadership");
